...
const projectSchema = z.object({ workspaceId: z.uuid(), ...projectFields });
...
export async function createWorkspace(
  ...
  const result = workspaceSchema.safeParse(Object.fromEntries(formData));
...
export async function createProject(
  ...
  return { createdProjectId: data.id };
}
